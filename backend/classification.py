...
# كلمات دالة على محتوى إيجابي أو محايد — تمنع النموذج من إصدار حكم خاطئ
_SAFE_WORDS = {
    # شكر وتقدير
    "شكرا","شكراً","شكرًا","مشكور","مشكوره","جزاك","بارك","مشكورين",
    # دعاء وتهنئة
    "ماشاءالله","الله يوفق","الله يسعد","مبروك","مبارك","الله يبارك",
    "يعطيك","يعطيج","يعطيكم","يسلمك","يسلمج","بالتوفيق","الله يعينك",
    # مدح وإطراء
    "ممتاز","رائع","رائعه","جميل","جميله","احسنت","احسن","عظيم",
    "متميز","ممتازه","بديع","روعه","روعة","تمام","عاش","يسلم",
    # نجاح
    "نجحت","نجح","تفوق","تميز","انجزت","انهيت","اكملت",
    # كلمات محايدة شائعة
    "كيف","حالك","حالج","حالكم","خير","بخير","الحمدلله","الحمد",
    "مرحبا","اهلا","السلام","وعليكم","هلا","هلو","صباح","مساء",
    "يوم","ايام","وقت","لحظه","الان","اليوم","امس","غدا",
    "اريد","ابغا","ابي","ممكن","لو","لو سمحت","من فضلك",
    "مساعده","مساعدة","مساعدتي","مساعدتك","ساعدني","افيدني",
    "سؤال","اسئلة","استفسار","معلومه","معلومة","معلومات",
    "كل","شيء","شي","شئ","عندي","عندك","معي","معك",
    "اعجبني","احببت","يسعدني","سعيد","سعيده","مسرور",
}
...
async def classify(req: TextRequest):
    ...
    threshold = 0.97 if safe else 0.85
